/*! For license information please see main.e1a845d4.js.LICENSE.txt */
(() => {
  var e = {
      43: (e, n, t) => {
        "use strict";
      ...
      111: () => {
        ...
        function n() {
          ...
          const t = document.getElementById("recordsContainer");
          (t.innerHTML = ""),
            n.forEach((e, n) => {
              ...
              const l = `\n            <div class="card-header">\n                <div>\n                    <div>${e.nome}</div>\n                    <div class="card-details">\n                        ${e.data} \u2014 ${e.turno} \u2014 ${e.status}\n                    </div>\n                </div>\n                <div>\n                    <div>VT: ${e.vt ? "\u2705" : "\u274c"}</div>\n                    <div>BH: ${e.bancoHoras >= 0 ? "+" : ""}${e.bancoHoras}h</div>\n                    <button class="danger" onclick="deleteRecord(${n})">Excluir</button>\n                </div>\n            </div>\n        `;
              (r.innerHTML = l), t.appendChild(r);
            });
        }
        function t() {
          const t = document.getElementById("statusFilter").value;
          n(t ? e.filter((e) => e.status === t) : e);
        }
        document.getElementById("statusFilter").addEventListener("change", t),
          n();
      },
      153: (e, n, t) => {
        "use strict";
      ...
      730: (e, n, t) => {
        ...
        function Hl() {
          if (!Vl && null !== Ul) {
            ...
            try {
              ...
              throw (null !== Ul && (Ul = Ul.slice(e + 1)), qe(Je, Hl), l);
            } finally {
              (kn = n), (Vl = !1);
            }
          }
        ...
        function na(e) {
          for (; e === Wl; )
            (Wl = jl[--Bl]), (jl[Bl] = null), (Ql = jl[--Bl]), (jl[Bl] = null);
          for (; e === Yl; )
            (Yl = ql[--Kl]),
              (ql[Kl] = null),
              (Gl = ql[--Kl]),
        ...
        var Zo = {
          ...
          Jo = {
            ...
            useImperativeHandle: function (e, n, t) {
              return (
                (t = null !== t && void 0 !== t ? t.concat([e]) : null),
                Mo(4194308, 4, $o.bind(null, n, e), t)
              );
            },
        ...
        var lu = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = $a(e, a, l)) && (ts(n, e, l, r), Va(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = $a(e, l, r)) && (ts(n, e, r, t), Va(n, e, r));
          },
        };
        ...
        function Iu(e, n, t) {
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, n, t, r, l, o, u) {
              if (t)
                return 256 & n.flags
                  ? ((n.flags &= -257), $u(e, n, u, (r = cu(Error(a(422))))))
              ...
              if ("$!" === l.data) {
                if ((r = l.nextSibling && l.nextSibling.dataset))
                  var i = r.dgst;
                return (
                  (r = i), $u(e, n, u, (r = cu((o = Error(a(419))), r, void 0)))
                );
              }
              ...
              if (((t = n.type), null !== e && null != n.stateNode))
                ...
                if (((e = Ka(Wa.current)), fa(n))) {
                  ...
                  switch (
                    ...
                    case "video":
                    case "audio":
                      for (l = 0; l < Or.length; l++) $r(Or[l], r);
                      break;
                    case "source":
                      $r("error", r);
                      break;
                  ...
                  e: {
                    switch (((i = be(t, r)), t)) {
                      ...
                      case "video":
                      case "audio":
                        for (l = 0; l < Or.length; l++) $r(Or[l], e);
                        l = r;
                        break;
                      case "source":
                        $r("error", e), (l = r);
              ...
              switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = rl(ws.bind(null, e, Vi, ji), n);
                    break;
                  }
                  ws(e, Vi, ji);
                  break;
        ...
        function cs(e) {
          ...
          try {
            ...
            (kn = r), (Pi.transition = t), 0 === (6 & (Ni = n)) && Hl();
          }
        }
        function fs() {
          (Ri = Mi.current), _l(Mi);
        ...
        function js(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = $a(l, n, o)) && (ts(e, l, o, a), Va(e, l, o)),
            o
          );
        }
        function Bs(e) {
  ...
  (t.n = (e) => {
    ...
    (() => {
      ...
      var e = t(391),
        ...
        r = t.n(n),
        l = t(579);
      e.createRoot(document.getElementById("root")).render((0, l.jsx)(r(), {}));
    })();
})();
//# sourceMappingURL=main.e1a845d4.js.map
